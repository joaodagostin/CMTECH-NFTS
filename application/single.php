...
$sql2 = "SELECT Nome_nft, Valor_nft, Descricao_nft, Data_nft, Id_nft, foto_nft, id FROM cadastro_nft WHERE Id_nft = '$id'";
$result2 = mysql_query($sql2);
$nfts = mysql_fetch_assoc($result2);
$nftsid = $nfts['id'];
$sql3 = "SELECT usuario FROM registro WHERE id = $nftsid";
$result3 = mysql_query($sql3);
$iduser = mysql_fetch_assoc($result3);
				...
				<div class="col-md-9 single_left">
				   <div class="single_image">
					     <ul id="etalage">
							<li>
								<a href="optionallink.php">
									<?php
										echo "<img class='etalage_thumb_image img-responsive3' src=".$nfts['foto_nft']." />";
										echo "<img class='etalage_source_image' src=".$nfts['foto_nft']." />";
									?>
								</a>
							</li>
						</ul>
				        ...
				        <div class="single_right">
				        	<h3><?php echo $nfts['Nome_nft']; ?></h3>
				        	<p class="m_10"><label>Criado por:</label> <a href="#"><?php echo $iduser['usuario'] ?>;</a></p>
							<p class="m_10"><label>Comprado por:</label> <a href="#">CMtech</a></p>
							<p class="m_10"><label><img src="images/coracao.png" width="20px" height="20px"/> <label>#</label>Favoritos</label></p>
							<br>
							<p class="m_10"><label>Preço atual</label></p>
							<p class="precoatual">
								<img src="images/ethereum (1).png" width="30px" height="30px"><label><?php echo $nfts['Valor_nft'] ?></label><label id="precoemreal">R$15,35</label>
							</p>
							<div class="btn_form">
							   <form>
								 <input type="submit" value="comprar agora" title="">
							  </form>
							</div>
							<ul class="add-to-links">
    			              <li><img src="images/wish.png" alt=""><a href="#">Adicionar aos favoritos</a></li>
    			            </ul>
